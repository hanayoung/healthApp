...
//
//                        var minNoseX : Float = 900.0F
//                        var maxNoseX : Float = 0.0F
//                        var minNoseY : Float = 900.0F
...
//
//                        cropImage(minLeftX,minLeftY,maxLeftX,maxLeftY,imageUri,cropImgLeft)
//                        cropImage(minRightX,minRightY,maxRightX,maxRightY,imageUri,cropImgRight)
...
//    }
//
//    private fun tensor4(imageBitmap: Bitmap){ // bitmap으로 이미지 전달받아서 색상 추출
//        val model = LiteModelImagenetMobilenetV3Large075224FeatureVector5Metadata1.newInstance(this)
//
...
//
//        val palette = Palette.from(bitmap).generate()
//        val test = palette.dominantSwatch
...
//    }
//
//    private fun cropImage(minX:Float,minY:Float,maxX:Float,maxY:Float,imageUri: Uri,img:ImageView){
//        val originalImage =
...
//
//        client.insertImg(body).enqueue(object: Callback<String>{
